...
Prepared 2026-09-15. Status: plan and option C artwork accepted; Bleu verified selection, slot movement, and hover text in game and published Workshop v0.8. The local expanded build contains 99 verified awards for 89 accounts; 22 awards await confirmation.
