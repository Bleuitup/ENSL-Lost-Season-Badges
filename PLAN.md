...
Prepared 2026-09-15. Status: plan and option C artwork accepted; Bleu verified selection, slot movement, and hover text in game and published Workshop v0.8. The local expanded build contains 119 distinct awards for 105 accounts. Made_in_Russia is the only unmapped recipient; the Void/Reguliym account overlap is tracked separately in GitHub issues.
