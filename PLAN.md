...
Prepared 2026-09-15. Status: plan and option C artwork accepted; Bleu verified selection, slot movement, and hover text in game and published Workshop v0.8. Bleu confirmed publication of v1.0 on 2026-09-16, with 119 distinct awards for 105 accounts. Made_in_Russia is the only unmapped recipient; the Void/Reguliym account overlap is tracked separately in GitHub issues.
...
Exclude artificial test grants from release. Bleu has confirmed NS2 ID 37745947 and the S13 D3 win, corroborated by the Hall of Fame roster; the first test uses that actual earned award, recorded with explicit provenance. Keep gameplay independent of live ENSL/Steam requests. Do not modify official entitlement checks.
